...
container2.write(
    "Information about the jank awards; Every week you can earn points by playing jank decks!"
)
...
container3.write(
    "This is where I would place my explenation about the stats...IF I HAD ANY!."
)
