...
def main():
    ...
    df = pd.DataFrame(rankings, columns=("_id", "playername", "playpoints", "attendancepoints","jankpoints", "overallpoints"))
    ...
    df = df.sort_values(by=["playpoints"], ascending=False)
    ...
    # Show in Streamlit
    st.dataframe(df_display, column_order=("Player Name", "Play Points", "Attendance Points", "Jank Points", "Overall Points"))
